...
// Validation webhook
func (r *SLVReconciler) ValidateCreate(ctx context.Context, slvObj *k8samagicomv1.SLV) error {
	logger := log.FromContext(ctx)
	logger.Info("ValidateCreate", "SLV", slvObj.Name)
	return nil
}

func (r *SLVReconciler) ValidateUpdate(ctx context.Context, slvObj, newSLV *k8samagicomv1.SLV) error {
	logger := log.FromContext(ctx)
	logger.Info("ValidateUpdate", "SLV", slvObj.Name)
	return nil
}

func (r *SLVReconciler) ValidateDelete(ctx context.Context, slvObj *k8samagicomv1.SLV) error {
	logger := log.FromContext(ctx)
	logger.Info("ValidateDelete", "SLV", slvObj.Name)
	return nil
}

// SetupWithManager sets up the controller with the Manager.
func (r *SLVReconciler) SetupWithManager(mgr ctrl.Manager) error {
	// Create a predicate function to filter out events generated by self
	// pred := predicate.Funcs{
	// 	CreateFunc: func(e event.CreateEvent) bool {
	// 		// Check if the event is not triggered by the owning object
	// 		return e.Object.GetOwnerReferences() == nil
	// 	},
	// 	UpdateFunc: func(e event.UpdateEvent) bool {
	// 		// Check if the event is not triggered by the owning object
	// 		if e.ObjectOld.GetOwnerReferences() != nil {
	// 			return true
	// 		}
	// 		return !reflect.DeepEqual(e.ObjectOld.GetManagedFields(), e.ObjectNew.GetManagedFields())
	// 	},
	// }
