...
func (r *SLVReconciler) SetupWithManager(mgr ctrl.Manager) error {
	// A predicate function to filter out events generated by self
	// pred := predicate.Funcs{
	// 	CreateFunc: func(e event.CreateEvent) bool {
	// 		return e.Object.GetObjectKind().GroupVersionKind().Kind == slvv1.Kind
	// 	},
	// 	UpdateFunc: func(e event.UpdateEvent) bool {
	// 		slvObjectDetected := e.ObjectOld.GetObjectKind().GroupVersionKind().Kind == slvv1.Kind ||
	// 			e.ObjectNew.GetObjectKind().GroupVersionKind().Kind == slvv1.Kind
	// 		nonSLVObjectsOwnedByController := (controllerutil.HasControllerReference(e.ObjectOld) &&
	// 			e.ObjectOld.GetObjectKind().GroupVersionKind().Kind != slvv1.Kind) ||
	// 			(controllerutil.HasControllerReference(e.ObjectNew) &&
	// 				e.ObjectNew.GetObjectKind().GroupVersionKind().Kind != slvv1.Kind)

	// 		return slvObjectDetected || nonSLVObjectsOwnedByController
	// 	},
	// 	DeleteFunc: func(e event.DeleteEvent) bool {
	// 		return !controllerutil.HasControllerReference(e.Object)
	// 	},
	// }
