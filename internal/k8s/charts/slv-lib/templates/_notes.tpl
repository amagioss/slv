...
NOTE: You have opted to attach your own service account with SLV. 
Ensure that the service account is bound a role/clusterRole with the following priveleges:
- apiGroups: ["slv.sh"]
resources: ["slvs"]
verbs:
    - "get"
