...
var ErrInvalidEnvAccessBindingFormat = errors.New("invalid environment access binding format")
var ErrEnvAccessBindingUnspecified = errors.New("environment access binding unspecified")
